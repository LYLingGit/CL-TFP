...
public class KMeans {
    ...
    public KMeans(double[][] projectRequireMatrix, double[][] sociometricMatrix, List<Learner> learners) {
    ...
    public double proceed(String evolutionStorePath, String allocationStorePath, double a, double b, double c) {
        ...
        socioDistance = calculateSocioDistanceOrder();
        double systemEvolution = adjustProjectMemberBasedSocio(socioDistance);
